...
def _resnet(block, num_classes, fuse_type, small_input, **kwargs):
    model = ResNet(block, num_classes=num_classes, fuse_type=fuse_type, small_input=small_input, **kwargs)
    return model


def aff_net(num_classes, fuse_type='DAF', **kwargs):
    r"""
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(BasicBlock, num_classes, fuse_type, **kwargs)
